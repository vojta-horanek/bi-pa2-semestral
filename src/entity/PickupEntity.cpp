...
PickupEntity::PickupEntity(Texture texture, int frameCount, bool synchronized, int speed)
        : AnimatedEntity(texture, frameCount, synchronized, speed) {
    collisionType = Collision::SOFT;
}

PickupEntity::PickupEntity(Texture texture) : PickupEntity(texture, 1, true, 0) {}
